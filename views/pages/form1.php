...
<div class="container">
    <div class="pageContent">
        <div id="formOneHead">
            ...
            <div id="tableLink">
            <a class="allMembers"
               href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ?>/?controller=pages&action=table">
                All members (<?php echo $allMembers ?>)</a>
            </div>
        </div>
                ...
                <div id="partOne">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input id="name" name="Name" type="text" placeholder="First Name"
                                       class="form-control input-md is-invalid"
                                       required>
                            </div>
                            <div id="nameErrorSpanDiv" class="col-md-4 errorSpanDiv"><span id="nameErrorSpan" class="help-block">Please correct the error</span></div>
                        </div>
                    </div>
                    ...
                    <div id="surnameGroup" class="form-group">
                        <div class="row">
                            ...
                            <div id="surnameErrorSpanDiv" class="col-md-4 errorSpanDiv"><span id="surnameErrorSpan" class="help-block">Please correct the error</span></div>
                        </div>
                    </div>
                    ...
                    <div id="birthdateGroup" class="form-group">
                        <div class="row">
                            ...
                            <div class='col-md-4'>
                                <input id="birthdate" class="form-control input-md" type="text" readonly="readonly" placeholder="22-09-1990"
                                       required>
                            </div>
                            <div id="birthdateErrorSpanDiv" class="col-md-4 errorSpanDiv"><span id="birthdateErrorSpan" class="help-block">Please correct the error</span></div>
                        </div>
                    </div>
                    ...
                    <div id="reportGroup" class="form-group">
                        <div class="row">
                            ...
                            <div id="reportErrorSpanDiv"  class="col-md-4 errorSpanDiv"><span id="reportErrorSpan" class="help-block">Please correct the error</span></div>                        </div>
                    </div>
                    ...
                    <div id="countryGroup" class="form-group">
                        <div class="row">
                            ...
                            <div id="countryErrorSpanDiv" class="col-md-4 errorSpanDiv"><span id="countryErrorSpan" class="help-block">Please correct the error</span></div>
                        </div>
                    </div>
                    ...
                    <div id="phoneGroup" class="form-group">
                        <div class="row">
                            ...
                            <div id="phoneErrorSpanDiv" class="col-md-4 errorSpanDiv"><span id="phoneErrorSpan" class="help-block">Please correct the error</span></div>
                        </div>
                    </div>
                    ...
                    <div id="mailGroup" class="form-group">
                        <div class="row">
                            ...
                            <div id="mailErrorSpanDiv" class="col-md-4 errorSpanDiv"><span id="mailErrorSpan" class="help-block">Please correct the error</span></div>
                        </div>
                    </div>
                </div>
                ...
                <div id="partTwo">
                    <div id="companyGroup" class="form-group">
                        <div class="row">
                            ...
                            <div id="companyErrorSpanDiv" class="col-md-4 errorSpanDiv"><span id="companyErrorSpan" class="help-block">Please correct the error</span></div>
                        </div>
                    </div>
                    ...
                    <div id="positionGroup" class="form-group">
                        <div class="row">
                            ...
                            <div id="positionErrorSpanDiv" class="col-md-4 errorSpanDiv"><span id="positionErrorSpan" class="help-block">Please correct the error</span></div>
                        </div>
                    </div>
                    ...
                    <textarea class="form-control" id="about" name="about"
                            ...
                            <div id="aboutErrorSpanDiv" class="col-md-4 errorSpanDiv"><span id="aboutErrorSpan" class="help-block">Please correct the error</span></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="errorSpanDiv" class="col-md-4"><span class="help-block">Please correct the error</span></div>
                        </div>
                    </div>
                </div>
                <!-- Prev + Next buttons -->
        ...
        <div id="shareDiv">
            ...
            <a class="fa fa-google-plus"
               href=""
               onClick="openSocialLink(event, '<?php echo $googlePlusLink ?>', 'Google Plus')"
               target="_blank"></a>
            <!--  Facebook share button-->
            <a class="fa fa-facebook"
               href=""
               onClick="openSocialLink(event, '<?php echo $facebookLink ?>', 'Google Plus')"
               target="_blank"></a>
            <!-- Twitter button-->
            <a class="fa fa-twitter"
               href=""
               onClick="openSocialLink(event, '<?php echo $twitterLink ?>', 'Twitter')"
                target="_blank"></a>
